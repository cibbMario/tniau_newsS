            ...
            <div class="tab-content-container">
                ...
                <div class="tab-pane <?= $view==='semua' ? 'active':'' ?>" id="pane-semua">
                    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:20px;">
                        <div>
                            <h2 style="color:var(--navy);font-weight:700;margin:0;font-size:22px">Selamat datang, <?= e($user['full_name']) ?>!</h2>
                            <p style="color:var(--text-sec);font-size:13px;margin-top:4px">Ringkasan monitoring publikasi berita & media TNI Angkatan Udara.</p>
                        </div>
                        <?php if ($user['role'] === 'A'): ?>
                    ...
                    <!-- SENTIMENT SUMMARY & RECENT NEWS GRID -->
                    <div style="display:grid;grid-template-columns:1fr 2fr;gap:20px;margin-bottom:24px">
                        <div class="card smooth-card">
                            <h3 style="font-size:14px;border-bottom:1px solid var(--border);padding-bottom:10px;margin-bottom:14px;color:var(--navy)">Analisis Sentimen Publik</h3>
                        ...
                        <div class="card smooth-card">
                            <div style="display:flex;justify-content:space-between;align-items:center;border-bottom:1px solid var(--border);padding-bottom:10px;margin-bottom:14px">
                                <h3 style="font-size:14px;margin:0;color:var(--navy)">Distribution Media Overview</h3>
                                <span style="font-size:12px;color:var(--text-sec)">Total: <?= $stats['total'] ?> Berita</span>
                            </div>
                            <div style="display:flex;gap:12px;justify-content:space-around;text-align:center;padding:10px 0">
                                <div>
                                    <div style="font-size:24px;font-weight:700;color:#2563eb"><?= $stats['wilayah'] ?></div>
                                    <div style="font-size:12px;color:var(--text-sec)">📍 Berita Wilayah</div>
                                </div>
                                <div style="border-left:1px solid #e2e8f0;height:40px"></div>
                                <div>
                                    <div style="font-size:24px;font-weight:700;color:#059669"><?= $stats['online'] ?></div>
                                    <div style="font-size:12px;color:var(--text-sec)">🌐 Media Online</div>
                                </div>
                                <div style="border-left:1px solid #e2e8f0;height:40px"></div>
                                <div>
                                    <div style="font-size:24px;font-weight:700;color:#d97706"><?= $stats['sosial'] ?></div>
                                    <div style="font-size:12px;color:var(--text-sec)">📱 Media Sosial</div>
                                </div>
                            </div>
                        </div>
                    </div>

                    <!-- RECENT NEWS STREAM TABLE -->
                    <div class="card smooth-card">
                        <div style="display:flex;justify-content:space-between;align-items:center;border-bottom:1px solid var(--border);padding-bottom:10px;margin-bottom:14px">
                            <h3 style="font-size:14px;margin:0;color:var(--navy)">Berita & Publikasi Terbaru</h3>
                            <a href="<?= BASE_URL ?>/news_list.php" style="font-size:12px;color:var(--blue);font-weight:600;text-decoration:none">Lihat Semua →</a>
                        </div>
                            ...
                            <table class="news-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size:12px;color:var(--text-sec)"><?= e($r['author_name']) ?></td>
                ...
                <div class="tab-pane <?= $view==='wilayah' ? 'active':'' ?>" id="pane-wilayah">
                    <div class="card smooth-card mb-4">
                        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px">
                            <h3 style="font-size:16px;color:var(--navy);margin:0">📍 Monitoring Berita Wilayah / Lanud / Satuan</h3>
                            ...
                            <table class="news-table">
                                ...
                                <tbody>
                                    <?php if(empty($regionalNews)): ?>
                                        <tr><td colspan="5" style="text-align:center;padding:24px;color:var(--text-sec)">Belum ada data berita wilayah.</td></tr>
                                    <?php else: ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="font-size:12px"><?= e($rn['author_name']) ?></td>
                ...
                <div class="tab-pane <?= $view==='online' ? 'active':'' ?>" id="pane-online">
                    <div class="card smooth-card mb-4">
                        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px">
                            <h3 style="font-size:16px;color:var(--navy);margin:0">🌐 Monitoring Portal Media Online Nasional & Lokal</h3>
                            ...
                            <table class="news-table">
                                ...
                                <tbody>
                                    <?php if(empty($onlineNews)): ?>
                                        <tr><td colspan="5" style="text-align:center;padding:24px;color:var(--text-sec)">Belum ada data berita media online.</td></tr>
                                    <?php else: ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="font-size:12px"><?= e($on['author_name']) ?></td>
                ...
                <div class="tab-pane <?= $view==='sosial' ? 'active':'' ?>" id="pane-sosial">
                    <div class="card smooth-card mb-4">
                        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px">
                            <h3 style="font-size:16px;color:var(--navy);margin:0">📱 Monitoring & Analisis Media Sosial</h3>
                            ...
                            <table class="news-table">
                                ...
                                <tbody>
                                    <?php if(empty($socialNews)): ?>
                                        <tr><td colspan="5" style="text-align:center;padding:24px;color:var(--text-sec)">Belum ada data media sosial.</td></tr>
                                    <?php else: ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="font-size:12px"><?= e($sn['author_name']) ?></td>
                ...
                <div class="tab-pane <?= $view==='statistics' ? 'active':'' ?>" id="pane-statistics">
                    <div class="card smooth-card mb-4">
                        <h3 style="font-size:16px;color:var(--navy);margin-bottom:16px">📊 Statistik Distribution & Analysis</h3>
                        <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px">
                            <!-- Sentimen breakdown -->
                            <div style="background:#f8fafc;padding:20px;border-radius:12px;border:1px solid #e2e8f0">
                                <h4 style="font-size:14px;margin-bottom:14px;color:var(--navy)">Persentase Sentimen</h4>
                            ...
                            <div style="background:#f8fafc;padding:20px;border-radius:12px;border:1px solid #e2e8f0">
                                <h4 style="font-size:14px;margin-bottom:14px;color:var(--navy)">Distribusi Kanal Media</h4>
                                <?php 
                ...
                <div class="tab-pane <?= $view==='report' ? 'active':'' ?>" id="pane-report">
                    <div class="card smooth-card mb-4">
                        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px">
                            <h3 style="font-size:16px;color:var(--navy);margin:0">📄 Report Monitoring Kontributor & Publikasi</h3>
                            <button onclick="window.print()" class="btn btn-outline btn-sm">🖨️ Cetak Laporan</button>
                        </div>
                        <div class="news-table-wrap">
                            <table class="news-table">
                                <thead>
                ...
                <div class="tab-pane <?= $view==='gallery' ? 'active':'' ?>" id="pane-gallery">
                    <div class="card smooth-card mb-4">
                        <h3 style="font-size:16px;color:var(--navy);margin-bottom:16px">🖼️ Galeri Media Foto & Dokumentasi</h3>
                        <?php if(empty($allGallery)): ?>
                            <p style="color:var(--text-sec);text-align:center;padding:30px">Belum ada dokumentasi foto berita.</p>
                        <?php else: ?>
